...
class load:
    ...
    def getinstr(self):
        ...
        rv.append(["32(....)", "W", "LD ({0}),A"])
        rv.append(["DD32(....)", "W", "LD ({0}),A"])
        rv.append(["FD32(....)", "W", "LD ({0}),A"])
        rv.append(["3A(....)", "W", "LD A,({0})"])
        rv.append(["DD3A(....)", "W", "LD A,({0})"])
        rv.append(["FD3A(....)", "W", "LD A,({0})"])

        # load (ind),hl; load hl,(ind)
        rv.append(["22(....)", "W", "LD ({0}),HL"])
        rv.append(["DD22(....)", "W", "LD ({0}),IX"])
        rv.append(["FD22(....)", "W", "LD ({0}),IY"])
        rv.append(["2A(....)", "W", "LD HL,({0})"])
        rv.append(["DD2A(....)", "W", "LD IX,({0})"])
        rv.append(["FD2A(....)", "W", "LD IY,({0})"])
        ...
        for rp in range(4):
            ...
            r = rpname[rp]
            rv.append(["ED" + s1 + "(....)", "W", "LD ({0})," + r])
            rv.append(["ED" + s2 + "(....)", "W", "LD " + r + ",({0})"])
